...
// Question 1
document.getElementById("host-name").innerHTML = "Syeda Shahriah"
document.getElementById("collaborator-name").innerHTML = "Terri Kang"
...
//     if (document.getElementById("instruction_button").value=='HIDE'){
//         document.getElementById("instruction_button").value=='SHOW'
//     }
//     if (document.getElementById("instruction_button").value=='SHOW'){
//         document.getElementById("instruction_button").value=='HIDE'
//     }
// }
